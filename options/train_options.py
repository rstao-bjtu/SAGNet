...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset1_root', type=str, default='./dataset/', help='path to images of domain 1')
        parser.add_argument('--dataset2_root', type=str, default='./dataset/', help='path to images of domain 2')
        parser.add_argument('--mode_method', type=str, default='', help='baseline, ours')
        parser.add_argument('--lamda', type=float, default=1, help='weight for the loss')
